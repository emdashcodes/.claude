...
allowed-tools: Bash, Read, Write, Edit, MultiEdit, Glob, Grep, LS, TodoRead, TodoWrite, Task, WebFetch, mcp__perplexity-mcp__perplexity_search_web, NotebookRead, NotebookEdit
---
...
- Read all spec files (requirements.md, design.md and tasks.md) yourself and NOT with a sub agent. Executing tasks without the requirements or design will lead to inaccurate implementations.
